...
// Supports add, sub, mul (integer arithmetic for testing)
//=======================================================
...
module fpu_top(
    ...
    // Output result (lecture toujours disponible)
    assign data_out = result;

    //===================================================
    // Arithmetic Operations (integer for testing)
    // TODO: Replace with IEEE-754 floating point
    //===================================================
